...
export const mutations = {
  ...
  setUserInfo(data, { cover } = { cover: false }) {
    ...
    const userInfo = cover ? data : Object.assign(store.userInfo, data)
  ...
  async logout() {
    ...
    uni.redirectTo({
      url: `/${pagesJson.uniIdRouter && pagesJson.uniIdRouter.loginPage ? pagesJson.uniIdRouter.loginPage : 'uni/uni-id-pages/pages/login/login-withoutpwd'}`,
    })
  },
  loginBack(e = {}) {
