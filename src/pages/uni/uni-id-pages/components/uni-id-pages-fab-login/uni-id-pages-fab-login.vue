...
<script>
import config from '@/uni/uni-id-pages/config.js'
// 前一个窗口的页面地址。控制点击切换快捷登录方式是创建还是返回
import { store, mutations } from '@/uni/uni-id-pages/common/store.js'
      ...
      servicesList: [
        {
          id: 'username',
          text: '账号登录',
          logo: '/uni/uni-id-pages/static/login/uni-fab-login/user.png',
          path: '/uni/uni-id-pages/pages/login/login-withpwd',
        },
        {
          id: 'smsCode',
          text: '短信验证码',
          logo: '/uni/uni-id-pages/static/login/uni-fab-login/sms.png',
          path: '/uni/uni-id-pages/pages/login/login-withoutpwd?type=smsCode',
        },
        {
          id: 'weixin',
          text: '微信登录',
          logo: '/uni/uni-id-pages/static/login/uni-fab-login/weixin.png',
        },
        {
          id: 'huawei',
          text: '华为登录',
          logo: '/uni/uni-id-pages/static/login/uni-fab-login/huawei.png',
          path: '/uni/uni-id-pages/pages/login/login-withoutpwd?type=huawei',
        },
        {
          id: 'huaweiMobile',
          text: '华为账号一键登录',
          logo: '/uni/uni-id-pages/static/login/uni-fab-login/huawei.png',
          path: '/uni/uni-id-pages/pages/login/login-withoutpwd?type=huaweiMobile',
        },
        // #ifndef MP-WEIXIN
        {
          id: 'apple',
          text: '苹果登录',
          logo: '/uni/uni-id-pages/static/uni-fab-login/apple.png',
        },
        {
          id: 'univerify',
          text: '一键登录',
          logo: '/uni/uni-id-pages/static/app/uni-fab-login/univerify.png',
        },
        {
          id: 'taobao',
          text: '淘宝登录', // 暂未提供该登录方式的接口示例
          logo: '/uni/uni-id-pages/static/app/uni-fab-login/taobao.png',
        },
        {
          id: 'facebook',
          text: '脸书登录', // 暂未提供该登录方式的接口示例
          logo: '/uni/uni-id-pages/static/app/uni-fab-login/facebook.png',
        },
        {
          id: 'alipay',
          text: '支付宝登录', // 暂未提供该登录方式的接口示例
          logo: '/uni/uni-id-pages/static/app/uni-fab-login/alipay.png',
        },
        {
          id: 'qq',
          text: 'QQ登录', // 暂未提供该登录方式的接口示例
          logo: '/uni/uni-id-pages/static/app/uni-fab-login/qq.png',
        },
        {
          id: 'google',
          text: '谷歌登录', // 暂未提供该登录方式的接口示例
          logo: '/uni/uni-id-pages/static/app/uni-fab-login/google.png',
        },
        {
          id: 'douyin',
          text: '抖音登录', // 暂未提供该登录方式的接口示例
          logo: '/uni/uni-id-pages/static/app/uni-fab-login/douyin.png',
        },
        {
          id: 'sinaweibo',
          text: '新浪微博', // 暂未提供该登录方式的接口示例
          logo: '/uni/uni-id-pages/static/app/uni-fab-login/sinaweibo.png',
        },
        // #endif
      ],
      univerifyStyle: {
  ...
  methods: {
    ...
    toPage(path, index = 0) {
      ...
      if (
        ...
        this.getRoute(1) == '/uni/uni-id-pages/pages/login/login-withoutpwd'
      ) {
        // 如果要被打开的页面已经打开，且这个页面是 /uni/uni-id-pages/pages/index/index 则把类型参数传给他
    ...
    async login_before(type, navigateBack = true, options = {}) {
      ...
      // 提示空实现
      if (
        ['qq', 'xiaomi', 'sinaweibo', 'taobao', 'facebook', 'google', 'alipay', 'douyin'].includes(
          type,
        )
      ) {
      ...
      if (type != 'univerify' && needAgreements && !this.agree) {
        const agreementsRef = this.getParentComponent().$refs.agreements
      ...
      if (type == 'weixin') {
        ...
        // 				'/uni/uni-id-pages/pages/login/login-withoutpwd?is_weixin_redirect=true&type=weixin'
        // #ifdef VUE2
      ...
      if (type == 'univerify') {
        ...
        const onButtonsClickFn = async (res) => {
          console.log(
            ...
            res,
            res.provider,
            this.univerifyStyle.buttons.list,
          )
          ...
          if (path) {
            if (
              this.getRoute(1).includes('login-withoutpwd') &&
              path.includes('login-withoutpwd')
            ) {
