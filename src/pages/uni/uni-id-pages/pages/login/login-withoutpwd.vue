    ...
    <template v-if="['apple', 'weixin', 'weixinMobile', 'huawei', 'huaweiMobile'].includes(type)">
      ...
      <view class="quickLogin">
        ...
        <view v-else style="position: relative">
          ...
          <view
            v-if="this.needAgreements && !this.agree"
...
export default {
  ...
  computed: {
    ...
    imgSrc() {
      // 大快捷登录按钮图
      const images = {
        weixin: '/uni/uni-id-pages/static/login/weixin.png',
        apple: '/uni/uni-id-pages/static/app/apple.png',
        huawei: '/uni/uni-id-pages/static/login/huawei.png',
        huaweiMobile: '/uni/uni-id-pages/static/login/huawei-mobile.png',
      }
